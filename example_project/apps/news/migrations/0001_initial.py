    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('call_to_action', models.ForeignKey(blank=True, help_text='By default the call to action will be the same as the news feed. You can override it for a specific article here.', null=True, on_delete=django.db.models.deletion.CASCADE, to='components.CallToAction')),
                ('card_image', cms.apps.media.models.ImageRefField(blank=True, help_text="By default the card will try and use the main image, if it doesn't look right you can override it here.", null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='media.File')),
            ],
            options={
                'ordering': ['-date'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('per_page', models.IntegerField(blank=True, default=12, null=True, verbose_name='Articles per page')),
                ('call_to_action', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='components.CallToAction')),
            ],
            options={
                'abstract': False,
            },
